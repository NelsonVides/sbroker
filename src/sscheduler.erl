...
?DOC("""
Lookup the pid or process name of one element,
selected based on the scheduler id, in a tuple of process names.
...
?DOC("""
Send a message to one element, selected based on the scheduler id, in a tuple of process names.
